...
public final class DApplication extends DBase {
	...
	public String get_creator(DBase parent, String window){ 
		...
		sb.append(Messages.build(SET_G4P_MESSAGES, _0951_show_messages));
		sb.append(Messages.build(SET_SKETCH_COLOR, _0952_col_scheme));
		if(_0953_cursor) {
			sb.append(Messages.build(SET_CURSOR_OFF, _0954_cursor_off));
		}
		else {
			sb.append(Messages.build(SET_MOUSE_OVER_ON, _0953_cursor));		
		}
