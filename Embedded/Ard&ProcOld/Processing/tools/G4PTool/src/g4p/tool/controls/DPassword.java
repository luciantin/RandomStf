...
public class DPassword extends DBaseVisual {
	...
	protected String get_creator(DBase parent, String window){
		...
		if(_0186_horz_scrollbar){
			...
			s = Messages.build(CTOR_GPASSWORD2, _0010_name, window, $(_0820_x), $(_0821_y), $(_0826_width), $(_0827_height), sbpolicy);
		}
		else {
			s = Messages.build(CTOR_GPASSWORD1, _0010_name, window, $(_0820_x), $(_0821_y), $(_0826_width), $(_0827_height));
		}
		s += Messages.build(PWORD_SIZE, _0010_name, $(_0125_pwsize));
