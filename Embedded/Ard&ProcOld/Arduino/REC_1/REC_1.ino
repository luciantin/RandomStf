...
{ 
 // Serial.print(kod);
  ...
  else if(kod==2) //nazad
  {
    ...
    analogWrite(Enable_A, 120); 
    analogWrite(Enable_B, 120-40);    
  }
  ...
  else if(kod==3) //napred
  {
    ...
    analogWrite(Enable_A, 120); 
    analogWrite(Enable_B, 120-30);    
  } 
 
   else if(kod==4) 
  {
   digitalWrite(Kotac_1_2, HIGH);
   analogWrite(Enable_A,90);
  } 
   ...
   else if(kod==5) 
  {
   ...
   else if(kod==6) //napred_brzo
  {
    digitalWrite(Kotac_2_2, HIGH);
    digitalWrite(Kotac_1_2, HIGH);
    analogWrite(Enable_A, 240); 
    analogWrite(Enable_B, 240-40);    
  }
  
  else if(kod==7) //NAPRED DESNO
  {
    digitalWrite(Kotac_2_1, HIGH);
    digitalWrite(Kotac_1_1, HIGH);
    analogWrite(Enable_A, 240); 
